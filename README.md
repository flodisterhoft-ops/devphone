...
**Phones and tablets that live on your desktop.**

Test mobile-first sites the way your clients actually see them — a realistic,
draggable device body with a real home screen, browser chrome, PWA install
flow, tablet portrait/landscape rotation, and a **true WebKit (Safari) engine**
running on Windows.
...
<sub>A real home screen, any site in a real Safari frame, and multiple devices — the window <b>is</b> the device. Drag it anywhere.</sub>
...
mode doesn't tell you what a site *feels* like on a phone or tablet. DevPhone runs real
mobile-web emulation inside an actual device body — so the toolbars, safe areas,
...
- **Two engines**
  ...
  - **WebKit** *(true engine)* — real WebKit via Playwright, streamed into the
    same device frame. Catches the "Chrome renders it fine but Safari doesn't"
...
- **Home screen & PWA flow** — Safari / Chrome / Samsung Internet apps;
  ...
  standalone (chrome-less) like the selected device. Long-press to wiggle & remove.
...
- **📸 Screenshots** — page-only or the whole device (pretty frame included),
...
Choose **Device → Tablet**, then pick from multiple iPad generations or the
Galaxy Tab S11 / S11 Ultra. The Rotate button switches the selected tablet
between portrait and landscape.

<div align="center">
  <p>
    <img src="assets/tablet-picker.png" width="340" alt="Separate tablet picker with iPads and Galaxy Tabs">
    <img src="assets/tablet-portrait.png" width="340" alt="Galaxy Tab S11 Ultra in portrait mode">
  </p>
  <img src="assets/tablet-landscape.png" width="720" alt="Galaxy Tab S11 Ultra in landscape mode">
  <br>
